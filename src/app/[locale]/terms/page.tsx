...
export const metadata: Metadata = {
  ...
  description: "CGU de Yelha — conditions d'utilisation du service.",
};
        ...
        {[
          {
            ...
            content: `Yelha est une plateforme SaaS qui permet aux entreprises et professionnels algériens de créer des bots Telegram alimentés par l'intelligence artificielle.\n\nEn utilisant Yelha, vous acceptez les présentes conditions d'utilisation.`,
          },
          {
            title: '2. Inscription et compte',
            content: `• Vous devez fournir des informations exactes lors de l'inscription\n• Vous êtes responsable de la confidentialité de vos identifiants\n• Un compte par personne physique ou morale\n• Vous devez avoir au moins 18 ans pour utiliser le service\n• Yelha se réserve le droit de suspendre tout compte en cas d'utilisation abusive`,
          },
          {
